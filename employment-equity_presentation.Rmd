...
# To run the file:
# rmarkdown::render("employment-equity_presentation.Rmd", output_file = "index.html")
...
colnames(median_df_wide) <- c("Year", "All Employees", "Non-Visible Minority Employees", "Visible Minority Employees","Black Employees", "Indigenous Employees",  "Employees with Disabilities")
...
datasets_en$quintile <- dplyr::recode(datasets_en$`Salary range`, 
