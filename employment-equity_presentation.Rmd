...
```
# DI of all groups by salary range (2020-2017){.tabset}
```{r , warning = FALSE, echo =  FALSE, message = FALSE}
...
# DI of Black Employees vs Non-Visible Minority Employees over Time
...
# Plot
ggplot(datasets_en[datasets_en$`Year` != "2017" &
                     datasets_en$Subgroup %in% c("Non-Visible Minority Employees", "Black Employees"),]) +
  geom_bar(stat = "identity",
           position = "dodge",
           aes(x = Year,
               y = DI,
